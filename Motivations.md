...
> This, in turn, allows a client to use just one connection per origin to load a
> page.
...
Despite its ubiquity, REST alone is insufficient and inappropriate for defining
