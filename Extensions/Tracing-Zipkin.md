...
* **Flags**: (8 bits)
  ...
  * (**R**)eject: Tracing payload should not be sampled. (Ignored when S flag is set.)
  * (**S**)ampl: Tracing payload should be accepted for tracing. (Ignored when D flag is set.)
